...
<section class="bg-sand padding-large">
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6">
				<a href="#" class="product-image"><img src="image/book-5.png" alt="image"></a>
			</div>

			<div class="col-md-6 pl-5">
				<div class="product-detail">
					<h1>The Butterfly Lion</h1>
					<p>Fiction</p>
					<span class="price colored">$43.30</span>
					<h2>About the Author </h2>
					<p>	
                        About the author (2011) Michael Morpurgo OBE is one of Britain's best-loved writers for children, and has sold more than 35 million books around the world. He has written more than 150 novels and won many prizes, including the Smarties Prize, the Whitbread Award and the Blue Peter Book Award, while several of his books have been adapted for stage and screen, including the global theatrical phenomenon War Horse. Michael was Children’s Laureate from 2003 to 2005, and founded the charity Farms for City Children with his wife, Clare. He was knighted in 2018 for services to literature and charity.					
                    </p>
					<form action="" >
