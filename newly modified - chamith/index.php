        ...
        <?php
            foreach($list2 as $r2){
                ...
                <div class=\"content\">
                    ...
                    <a href=".$r2['page_name']." class=\"btn\">View</a>
                </div>
            </div>";
            }
        ?>
...
<section class="arrivals" id="arrivals">
    ...
    <div class="swiper arrivals-slider">
        ...
        <div class="swiper-wrapper">
            ...
            <a href="product1.php" class="swiper-slide box">
                <div class="image">
            ...
            <a href="product2.php" class="swiper-slide box">
                <div class="image">
            ...
            <a href="product3.php" class="swiper-slide box">
                <div class="image">
            ...
            <a href="product4.php" class="swiper-slide box">
                <div class="image">
            ...
            <a href="product5.php" class="swiper-slide box">
                <div class="image">
    ...
    <div class="swiper arrivals-slider">
        ...
        <div class="swiper-wrapper">
            ...
            <a href="product6.php" class="swiper-slide box">
                <div class="image">
            ...
            <a href="product7.php" class="swiper-slide box">
                <div class="image">
            ...
            <a href="product8.php" class="swiper-slide box">
                <div class="image">
            ...
            <a href="product9.php" class="swiper-slide box">
                <div class="image">
            ...
            <a href="product10.php" class="swiper-slide box">
                <div class="image">
