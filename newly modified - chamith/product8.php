...
<section class="bg-sand padding-large">
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6">
				<a href="#" class="product-image"><img src="image/book-8.png" alt="image"></a>
			</div>
			...
			<div class="col-md-6 pl-5">
				<div class="product-detail">
					...
					<p>Fiction</p>
					<span class="price colored">$32.82</span>
					<h2>From the Author </h2>
					<h3>Dear Reader,</h3>
					<p>	
						This labor of love took me a little over three years to write and two years to edit. I really like how it turned out, and I hope you do too. I didn't even intend to publish it at first, but 350 pages later, I knew I wanted to share this story.
					</p>
					<form action="">
					...
					<?php 
						...
						if(isset($_REQUEST["black history month"])){
							$bname = "THE DRAGON'S HEIR" ;
							$bprice =  32.82 ;
							$qty = $_REQUEST["qty"];
