        ...
        $sql = "SELECT book_name,img_name,price FROM books;";
    ...
    <div class="book-slides">
        <div id="category" class="row">
            ...
            <ul>
                ...
                <a href=""><li>Action and Adventure</li></a>
                <a href=""><li>Animal and Wildlife</li></a>
                <a href=""><li>English</li></a>
                <a href=""><li>Clildren's books</li></a>
                <a href=""><li>Historical</li></a>
                <a href=""><li>Biographies</li></a>
                <a href=""><li>Histoarical Fictions</li></a>
                <a href=""><li>Art and Theater</li></a>
            </ul>
        </div>
